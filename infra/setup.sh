...
echo "       aws ecs execute-command --cluster vexillo --task \"\$TASK_ARN\" --container api --interactive --command \"bun run apps/api/scripts/seed-org.ts 'Acme Corp' acme https://acme.okta.com/oauth2/default <clientId> <clientSecret>\""
echo ""
echo "  Verify:"
